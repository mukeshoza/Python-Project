...
class ScreenAnalysis:
    STAGING_URL = 'https://dev.conversionsondemand.com/codadmin2/'
    PRODUCTION_URL = 'https://conversionsondemand.com/codadmin2/'
    driver = None
    ...
    def set_up(self):
        self.driver = webdriver.PhantomJS(
            "E:\\pandas\\selenium\\phantomjs-2.1.1-windows\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe")

    def clean_up(self):
        self.driver.close()

    def capture_screens(self):
        self.screenshot(self.STAGING_URL, 'screenshot/screen_staging.png')
        self.screenshot(self.PRODUCTION_URL, 'screenshot/screen_production.png')

    def screenshot(self, url, file_name):
        print("Capturing", url, "screenshot as", file_name, "...")
        self.driver.get(url)
        self.driver.set_window_size(1024, 768)
        self.driver.save_screenshot(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'screenshot', file_name))
        self.driver.get_screenshot_as_png()
        print("Done.")

    def analyze(self):
        screenshot_staging = Image.open("screenshot/screen_staging.png")
        screenshot_production = Image.open("screenshot/screen_production.png")
        columns = 60
        rows = 80
